...
class ORMExerciesTestCase(TestCase):
    ...
    def test_task_2_first_song_ordered(self):
        ...
        assert song.title == 'Higher Ground'
        assert song.album_name == 'Innervisions'
    ...
    def test_task_4_artist_songs_contains(self):
        ...
        assert songs[0].artist.artistic_name == 'B.B. King'
    ...
    def test_task_5_songs_exclude(self):
        ...
        assert 'Thrill' not in songs[0].title
        assert 'Thrill' not in songs[1].title
