...
def task_1_artist_exists():
    ...
    return Artist.objects.filter(artistic_name__exact='Eric Clapton').exists()
...
def task_7_get_or_create_artist():
    ...
    if Artist.objects.filter(artistic_name='Eric Clapton').exists():
        ...
        eric = Artist.objects.create(artistic_name='Eric Clapton', first_name='Eric', last_name='Clapton', picture_url='http://www.aaa.com', popularity=100, genre='rock')
        return True
...
def task_9_update_song_artist():
    ...
    new_artist = Artist.objects.create(artistic_name='Foals', first_name='firstname', last_name='lastname', picture_url='http://www.111.com', popularity=100, genre='rock')
