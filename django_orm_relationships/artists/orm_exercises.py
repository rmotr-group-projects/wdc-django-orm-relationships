...
def task_1_artist_exists():
    ...
    return Artist.objects.filter(artistic_name__icontains='Eric Clapton').exists()
...
def task_9_update_song_artist():
    ...
    artist = Artist.objects.create(first_name='Eric', last_name='Clap', artistic_name='EC',popularity=90)
