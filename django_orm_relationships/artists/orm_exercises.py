...
def task_8_artist_songs_reverse_relationship():
    ...
    return artist.song_set.all() # HOW IS SONG_SET BEING DEFINED AND ACCESSED ??????
...
def task_9_update_song_artist():
    ...
    artist = Artist.objects.create(artistic_name='Nana Tetteh', first_name='Nana', last_name='Tetteh', popularity=10)
