...
def task_1_artist_exists():
    ...
    try:
        eric_clapton = Artist.objects.get(first_name = "Eric", last_name = "Clapton")
        return True
...
def task_6_artist_name_starts_with():
    ...
    Ji = Artist.objects.filter(artistic_name__startswith="Ji")
    return Ji.count()
