...
def task_1_artist_exists():
    ...
    return Artist.objects.filter(artistic_name='Eric Claption').exists()
...
def task_7_get_or_create_artist():
    ...
    return Artist.objects.get_or_create(artistic_name="Eric Clapton",defaults=
clapton_data)[1]
...
def task_9_update_song_artist():
    ...
    artist = Artist.objects.create(artistic_name='Billie Holiday', first_name='Billie', last_name='Holiday',popularity=90)
