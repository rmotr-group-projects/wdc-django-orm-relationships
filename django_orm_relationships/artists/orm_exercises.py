...
def task_6_artist_name_starts_with():
    ...
    return Artist.objects.filter(artistic_name__icontains='Ji').count()
...
def task_7_get_or_create_artist():
    ...
    eric, yorn = Artist.objects.get_or_create(artistic_name='Eric Clapton', defaults={'first_name': 'Eric','last_name': 'Clapton','popularity': 95})
...
def task_9_update_song_artist():
    ...
    artist = Artist.objects.create(artistic_name='Muskey', popularity=99)
